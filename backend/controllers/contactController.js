...
// @desc Get contact
// @route GET /api/contacts/getById/:id
// @access private
...
const createContact = asyncHandler(async (req, res) => {
    console.log("The response body is :", req.body);
...
// @desc Update contact
// @route Update /api/contacts/update/:id
// @access private
...
const deleteContact = asyncHandler(async (req, res) => {
    ...
    res.status(200).json({ message: "Contacted Deleted Successfully" });
});
